...
PixelToFrame BlockPS(VertexToPixel PSIn) 
{
	...
	float4 textureColor = tex2D(TextureSampler, PSIn.TextureCoords);
	Output.Color = textureColor * xColor;
	
	// Alpha test - discard pixels with alpha below threshold to prevent black backgrounds
