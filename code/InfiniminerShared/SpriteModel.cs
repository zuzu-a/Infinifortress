...
namespace Infiniminer
{
    ...
    public class SpriteModel
    {
        ...
        public SpriteModel(Game gameInstance, int numFrames)
        {
            ...
            this.nameFont = gameInstance.Content.Load<SpriteFont>("font_player");
        ...
        public void Draw(Matrix viewMatrix, Matrix projectionMatrix, Vector3 cameraPosition, Vector3 cameraForward, Vector3 drawPosition, Vector3 drawHeading, float drawScale, Vector4 col)
        {
            ...
            var alphaTestBlendState = new BlendState
            {
            ...
            graphicsDevice.BlendState = alphaTestBlendState;
        ...
        public void DrawBillboard(Matrix viewMatrix, Matrix projectionMatrix, Vector3 cameraPosition, Vector3 cameraForward, Vector3 drawPosition, Vector3 drawHeading, float drawScale, Vector4 col)
        {
            VertexPositionTexture[] vertices = GenerateVertices(cameraPosition, drawPosition, drawHeading, drawScale);
        ...
        public VertexPositionTexture[] GenerateVertices(Vector3 cameraPosition, Vector3 drawPosition, Vector3 drawHeading, float drawScale)
        {
            ...
            int spriteRow;
            // Check if this is a multi-row sprite (height > 32 suggests multiple rows)
            if (texSprite.Height > 32)
            {
                // Multi-row sprite (like players) - use directional views
            ...
            {
                // Single-row sprite (like items) - always use row 0
                spriteRow = 0;
            }

            float texX = currentColumn * frameWidth;
            float texY = spriteRow * frameHeight;
